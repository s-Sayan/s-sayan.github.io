...
\begin{document}
	...
	\cvitem{Postdoc Proj.}{Development of shape measurement and convergence reconstruction pipeline for SuperBIT, NASA’s balloon-based telescope, to extract unbiased shear estimates from targeted cluster observations.}
	...
	\cvitem{SuperBIT}{Leading development of the shape-measurement pipeline}
	\cvitem{CMB S4}{Member of Cluster-working group}
	\cvitem{Cosmoglobe}{part of the OpenHFI group}
	\cvitem{CMB-Bharat}{Web Coordinator (for the proposed CMB telescope from India)}
	
	
	\section{Contributed talks \& posters}
	\cvitem{July 2024}{Relativistic effects and Novel Observables in Cosmology, University of Geneva, Switzerland, \linebreak Talk - \textbf{Novel Bayesian Inferences from the Cosmic
	...
	\cvitem{Programming Languages}{Python, Fortran 90, Shell scripting}
	\cvitem{Open-Source Contributions}{%
		\begin{itemize}
			\item \chref{https://github.com/carronj/LensIt}{Lensit} – Maximum-a-posterior (MAP) reconstruction tool of CMB-lensing potential
			\item \chref{https://github.com/superbit-collaboration/superbit-lensing}{superbit-lensing} – Shear measuremnet pipeline for the SuperBIT telescope
			\item \chref{https://github.com/GeorgeVassilakis/SMPy}{SMPy} – A Python-based tool to reconstruct convergence maps from shear-measurements.
			\item \chref{https://github.com/s-Sayan/ShearNet}{ShearNet} – Neural network-based tool for galaxy shape measurement.
			\item \chref{https://github.com/s-Sayan/CosmoHMC}{CosmoHMC} – Hamiltonian Monte Carlo sampler for field level inference in Cosmology
		\end{itemize}
	}
	\cvitem{Scientific Codes}{ \chref{https://github.com/carronj/plancklens}{plancklens}, CAMB, HEALPix (healpy)}
	...
	\cvitem{Software \& Tools}{Git, LaTeX, HTML, HPC computing, Microsoft Office}
	%\pagebreak
	...
	\cvitem{Postdoc advisor}{Prof Jacqueline McCleary, Northeastern University, Boston, USA
		Email: \chref{mailto:j.mccleary@northeastern.edu}{j.mccleary@northeastern.edu}}
